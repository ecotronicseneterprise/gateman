...
| Operating the system | [`INSTALLATION.md`](docs/INSTALLATION.md) · [`PROVISIONING.md`](docs/PROVISIONING.md) · [`DEPLOYMENT.md`](docs/DEPLOYMENT.md) · [`TESTING.md`](docs/TESTING.md) · [`SECURITY.md`](docs/SECURITY.md) |
...
| Historical / superseded (kept for reference, see `CLEANUP_REPORT.md`) | `WIKI.md` · `plan.md` · `audit.md` · `FIX.MD` · `homepage.md` · `deployment_guide.md` · `VPS_RECOVERY_GUIDE.md` · `AUTO_DISCOVERY_PROVISIONING.md` · `SIMPLIFIED_PROVISIONING.md` · `FINAL_PROVISIONING_FLOW.md` · `ESP32-WROOM BRAIN FIRMWARE.md` · `ESP32-CAM SLAVE FIRMWARE.md` · `deploy_quick_commands.md` |
